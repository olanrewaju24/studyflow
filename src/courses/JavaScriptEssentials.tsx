...
const jsCourse = {
  ...
  subtitle: "Master the language that powers the web — from basics to advanced concepts.",
  ...
  previewVideo: "https://www.youtube.com/embed/W6NZfCO5SIk",
  features: [
    "12 hours of hands-on lessons",
  ...
  modules: [
    {
      ...
      lessons: [
        { title: "Variables and Data Types", duration: "15:22" },
        { title: "Operators and Expressions", duration: "20:10" },
      ],
    },
    {
      title: "Module 2: DOM and Events",
      lessons: [
        { title: "Accessing the DOM", duration: "18:12" },
        { title: "Event Handling", duration: "21:30" },
      ],
    },
  ],
};
      ...
      <main className="max-w-7xl mx-auto p-4 md:p-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <aside className="lg:sticky top-8 h-fit">
          <div className="border bg-white rounded-lg shadow-lg overflow-hidden">
            <img src="https://placehold.co/600x400/000000/FFFFFF/png?text=JavaScript+Preview" alt="Course preview" />
            <div className="p-6">
