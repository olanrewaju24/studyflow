...
const nodeCourse = {
  ...
  subtitle: "Build fast, scalable, and modern APIs using Node.js and Express.",
  ...
  previewVideo: "https://www.youtube.com/embed/Oe421EPjeBE",
  features: [
  ...
  learningOutcomes: [
    ...
    "Build RESTful APIs and handle routes",
  ...
  modules: [
    {
      ...
      lessons: [
        { title: "Introduction to Node.js", duration: "13:15" },
        { title: "Setting Up Express", duration: "18:22" },
      ],
    },
    {
      title: "Module 2: Building APIs",
      lessons: [
        { title: "Creating Routes and Controllers", duration: "20:45" },
        { title: "Connecting to MongoDB", duration: "25:00" },
      ],
    },
  ],
};
...
export default function NodejsBackendCourse() {
      ...
      <main className="max-w-7xl mx-auto p-4 md:p-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <aside className="lg:sticky top-8 h-fit">
          <div className="border bg-white rounded-lg shadow-lg overflow-hidden">
            <img src="https://placehold.co/600x400/000000/FFFFFF/png?text=Node.js+Preview" alt="Course preview" />
            <div className="p-6">
